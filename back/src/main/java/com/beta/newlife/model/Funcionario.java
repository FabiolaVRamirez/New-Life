...
public class Funcionario {
    ...
    public Funcionario(Long id, Long apartamento, String nome, String rg, String cpf, String telefone1,
            String telefone2, String observacao, Long id_morador) {
        this.id = id;
    ...
    public Funcionario(Long apartamento, String nome, String rg, String cpf, String telefone1, String telefone2,
            String observacao) {
        this.apartamento = apartamento;
        this.nome = nome;
        this.rg = rg;
